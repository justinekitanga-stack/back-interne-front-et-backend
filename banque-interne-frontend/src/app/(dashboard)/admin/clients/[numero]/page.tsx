// src/app/(dashboard)/admin/clients/[numero]/page.tsx
'use client';
...
export default function ClientDetailPage() {
  ...
  const handleBlock = async () => {
    try {
      await api.post('/clients/bloquer/', { 
        numero_compte: params.numero,
        raison: 'Bloqué par administrateur'
      });
          ...
          <Card title="Actions">
            <div className="space-y-2">
              <Button 
                className="w-full" 
                variant="primary"
                onClick={() => router.push(`/admin/transactions/depot?compte=${client.numero_compte}`)}
              >
              ...
              <Button 
                className="w-full" 
                variant="secondary"
                onClick={() => router.push(`/admin/transactions/retrait?compte=${client.numero_compte}`)}
              >
