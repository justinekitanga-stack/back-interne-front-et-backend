...
export default function ClientsPage() {
  ...
  const handleBlock = async (numeroCompte: string, e: React.MouseEvent) => {
    e.stopPropagation();
    try {
              ...
              <tbody>
                {filteredClients.map((client) => (
                  <tr 
                    ...
                    onClick={() => router.push(`/admin/clients/${client.numero_compte}`)}
                  >
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                        ...
                        {client.statut === 'ACTIF' && (
                          <button
                            onClick={(e) => handleBlock(client.numero_compte, e)}
